...
const OutlinedButton = ({ textColor, borderColor, disabled = false, onClick, children }: IOutlinedButtonProps) => {
    return (
      <StyledButton
        onClick={onClick}
        textColor={textColor}
...
const StyledButton = styled.button<IOutlinedButtonProps>`
  ...
  &:hover {
    background-color: ${(props) => props.borderColor ? lighten(0.35, props.borderColor) : '#eaeaea'};
